 ...
 */
public abstract class BinaryExprCautionaryIssue extends CautionaryIssue {

    protected final Expression leftExpr, rightExpr;
    protected final Type leftType, rightType;
    protected final BinaryOp op;

    protected BinaryExprCautionaryIssue(WarningCode code, Type leftType, Expression leftExpr,
