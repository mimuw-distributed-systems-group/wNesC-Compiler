...
public class NescWarning extends NescIssue {
    ...
    public NescWarning(Optional<Location> startLocation, Optional<Location> endLocation,
                       Optional<Issue.Code> code, String message) {
        super(startLocation, endLocation, code, message);
    }

    public NescWarning(Location startLocation, Optional<Location> endLocation,
                       Optional<Issue.Code> code, String message) {
