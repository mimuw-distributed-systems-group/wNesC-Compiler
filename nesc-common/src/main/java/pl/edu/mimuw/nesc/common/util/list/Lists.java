...
public class Lists {
	 ...
	 *
	 * @param list
	 *            the list which specified element should be added to
	 * @param item
	 *            the element to add
	 * @return the list with added element
	 * @throws NullPointerException
	 *             either list or item is null
	 */
	...
	/**
	 * Appends the specified element to the end of this list. When parameter
	 * item is <code>null</code> an empty list is returned.
	 *
	 * @param list
	 *            the list which specified element should be added to
	 * @param item
	 ...
	 *             list is null
	 */
	public static <T> LinkedList<T> chainNotNull(LinkedList<T> list, T item) {
		checkNotNull(list, "list should not be null");
	 ...
	 * @return merged lists
	 * @throws NullPointerException
	 *             any of specified lists is null
	 */
