    ...
    public Options newOptions() throws IOException {
        final Option[] options8051 = {
            ...
            Option.builder(OPTION_SHORT_PARTITION_HEURISTIC)
                ...
                .hasArg()
                .desc("heuristic to use for partitioning of functions into banks; available heuristics: simple, bcomponents, tmsearch, greedy-n where n is an arbitrary positive natural number; if this option is not specified, then heuristic 'greedy-10' is used")
